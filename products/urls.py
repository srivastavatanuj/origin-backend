...
urlpatterns = [
    ...
    path('product/list/<str:pk>/',
         ManageProductView.as_view(), name='product_manage'),
    ...
    path('my-cataloge/<str:pk>/',
         MyCatalogeProductView.as_view(), name='product_manage'),
    path('my-cataloge/<str:pk>/<int:id>/',
         MyCatalogeProductVarientView.as_view(), name='product_manage'),
]
