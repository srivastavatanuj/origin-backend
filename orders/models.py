...
class Payment(models.Model):
    ...
    payment_method = models.CharField(
        max_length=50)  # e.g., 'Razorpay', 'Stripe'
...
class Shipping(models.Model):
    STATUS_CHOICE = (('notshipped', 'Not Shipped Yet'), ('shipped',
                     'Shipped'), ('delivered', 'Delivered'), ('delayed', 'Delayed'))
    order = models.ForeignKey(
    ...
    status = models.CharField(choices=STATUS_CHOICE,
                              default='notshipped', max_length=50)
